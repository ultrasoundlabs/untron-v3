...
interface UntronV3IndexedOwnable {
...
pub mod UntronV3IndexedOwnable {
    use super::*;
    use alloy::sol_types as alloy_sol_types;
...
```*/
    ...
    ///Container for all the [`UntronV3IndexedOwnable`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum UntronV3IndexedOwnableCalls {
        #[allow(missing_docs)]
    ...
    impl UntronV3IndexedOwnableCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for UntronV3IndexedOwnableCalls {
        const NAME: &'static str = "UntronV3IndexedOwnableCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<UntronV3IndexedOwnableCalls>] = &[
                {
                    fn eventChainTip(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<UntronV3IndexedOwnableCalls> {
                        <eventChainTipCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(UntronV3IndexedOwnableCalls::eventChainTip)
                    }
                    eventChainTip
                },
                {
                    fn renounceOwnership(
                        ...
                        <renounceOwnershipCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(UntronV3IndexedOwnableCalls::renounceOwnership)
                    }
                    renounceOwnership
                },
                {
                    fn owner(
                        ...
                        <ownerCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(UntronV3IndexedOwnableCalls::owner)
                    }
                    owner
                },
                {
                    fn eventSeq(
                        ...
                        <eventSeqCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(UntronV3IndexedOwnableCalls::eventSeq)
                    }
                    eventSeq
                },
                {
                    fn transferOwnership(
                        ...
                        <transferOwnershipCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(UntronV3IndexedOwnableCalls::transferOwnership)
                    }
                    transferOwnership
                },
            ];
    ...
    ///Container for all the [`UntronV3IndexedOwnable`](self) custom errors.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum UntronV3IndexedOwnableErrors {
        #[allow(missing_docs)]
    ...
    impl UntronV3IndexedOwnableErrors {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for UntronV3IndexedOwnableErrors {
        const NAME: &'static str = "UntronV3IndexedOwnableErrors";
        const MIN_DATA_LENGTH: usize = 0usize;
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<UntronV3IndexedOwnableErrors>] = &[
                {
                    fn AlreadyInitialized(
                        ...
                        <AlreadyInitialized as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(UntronV3IndexedOwnableErrors::AlreadyInitialized)
                    }
                    AlreadyInitialized
                },
                {
                    fn NewOwnerIsZeroAddress(
                        ...
                        <NewOwnerIsZeroAddress as alloy_sol_types::SolError>::abi_decode_raw(
                            ...
                            .map(UntronV3IndexedOwnableErrors::NewOwnerIsZeroAddress)
                    }
                ...
                },
                {
                    fn Unauthorized(
                        ...
                        <Unauthorized as alloy_sol_types::SolError>::abi_decode_raw(data)
                            .map(UntronV3IndexedOwnableErrors::Unauthorized)
                    }
                    Unauthorized
                },
            ];
    ...
    ///Container for all the [`UntronV3IndexedOwnable`](self) events.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Debug, PartialEq, Eq, Hash)]
    pub enum UntronV3IndexedOwnableEvents {
        #[allow(missing_docs)]
    ...
    impl UntronV3IndexedOwnableEvents {
        /// All the selectors of this enum.
        ///
        /// Note that the selectors might not be in the same order as the variants.
        /// No guarantees are made about the order of the selectors.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for UntronV3IndexedOwnableEvents {
        const NAME: &'static str = "UntronV3IndexedOwnableEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for UntronV3IndexedOwnableEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    use alloy::contract as alloy_contract;
    /**Creates a new wrapper around an on-chain [`UntronV3IndexedOwnable`](self) contract instance.

See the [wrapper's documentation](`UntronV3IndexedOwnableInstance`) for more details.*/
    #[inline]
    pub const fn new<
        P: alloy_contract::private::Provider<N>,
        N: alloy_contract::private::Network,
    >(
        address: alloy_sol_types::private::Address,
        __provider: P,
    ) -> UntronV3IndexedOwnableInstance<P, N> {
        UntronV3IndexedOwnableInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<UntronV3IndexedOwnableInstance<P, N>>,
    > {
        UntronV3IndexedOwnableInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        UntronV3IndexedOwnableInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`UntronV3IndexedOwnable`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`UntronV3IndexedOwnable`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct UntronV3IndexedOwnableInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for UntronV3IndexedOwnableInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("UntronV3IndexedOwnableInstance").field(&self.address).finish()
        }
    }
    /// Instantiation and getters/setters.
    impl<
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<UntronV3IndexedOwnableInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> UntronV3IndexedOwnableInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> UntronV3IndexedOwnableInstance<P, N> {
            UntronV3IndexedOwnableInstance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
            }
