...
```*/
    ...
    ///Container for all the [`Multicallable`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum MulticallableCalls {
        #[allow(missing_docs)]
        multicall(multicallCall),
    }
    impl MulticallableCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for MulticallableCalls {
        const NAME: &'static str = "MulticallableCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<MulticallableCalls>] = &[
                {
                    fn multicall(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<MulticallableCalls> {
                        <multicallCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(MulticallableCalls::multicall)
                    }
                    multicall
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`Multicallable`](self) contract instance.

See the [wrapper's documentation](`MulticallableInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> MulticallableInstance<P, N> {
        MulticallableInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<MulticallableInstance<P, N>>,
    > {
        MulticallableInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        MulticallableInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`Multicallable`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`Multicallable`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct MulticallableInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for MulticallableInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("MulticallableInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<MulticallableInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> MulticallableInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> MulticallableInstance<P, N> {
            MulticallableInstance {
