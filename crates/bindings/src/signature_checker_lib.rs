...
See the [wrapper's documentation](`SignatureCheckerLibInstance`) for more details.*/
    ...
    >(
        ...
        SignatureCheckerLibInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        SignatureCheckerLibInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        SignatureCheckerLibInstance::<P, N>::deploy_builder(__provider)
    }
