...
/// HubChains : Current chain deprecation flags (KV)  Deprecated destination chains cannot be selected in new payout configs.
...
impl HubChains {
    /// Current chain deprecation flags (KV)  Deprecated destination chains cannot be selected in new payout configs.
    pub fn new() -> HubChains {
        HubChains {
