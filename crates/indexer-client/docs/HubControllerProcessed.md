...
------------ | ------------- | ------------- | -------------
**event_seq** | Option<**i32**> | Hub event sequence for this controller processing record  Note: This is a Primary Key.<pk/> | [optional]
**event_index** | Option<**f64**> | Index within the hub's controller event queue that was processed | [optional]
