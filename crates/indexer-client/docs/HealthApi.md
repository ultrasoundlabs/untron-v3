...
------------- | ------------- | -------------
[**health_get**](HealthApi.md#health_get) | **GET** /health | Health check endpoint



## health_get

> Vec<models::Health> health_get(status, select, order, range, range_unit, offset, limit, prefer)
