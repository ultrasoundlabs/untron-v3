...
**event_seq** | Option<**i32**> | Monotonic sequence number in the stream's onchain event hash-chain | [optional]
...
**block_number** | Option<**i32**> | Block number containing the EventAppended log | [optional]
**block_timestamp** | Option<**i32**> | Block timestamp (seconds since epoch) containing the EventAppended log | [optional]
